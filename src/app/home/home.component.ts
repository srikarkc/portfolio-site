...
export class HomeComponent {
  ...
  timeline = [
    { year: 'April 2023 - current', description: 'Leading DevOps projects for FHX internal application at Boeing.', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Boeing_full_logo.svg/2560px-Boeing_full_logo.svg.png' },
    ...
    { year: 'Sept 2001 - April 2014', description: 'Schooling at Indian School Muscat', image: 'https://ismoman.com/images/logo.png'},
  ];
